        ...
        {isEditing ? (
          <div className="space-y-3">
            ...
            <div className="relative rounded-2xl overflow-hidden border">
              <img src={preview} className="w-full h-48 object-cover opacity-70" alt="Preview" />
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={handleUpdate} disabled={loading} className="px-6 py-2 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-100">
                {loading ? "Saving..." : <span className="flex items-center gap-1"><Check size={18}/> Save</span>}
              </button>
            </div>
          </div>
        ) : (
          <>
            ...
            {preview && <img src={preview} className="w-full max-h-[500px] object-cover rounded-[1.5rem]" alt="Post" />}
          </>
        )}
      </div>
